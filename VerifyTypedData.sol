...
*/
        ...
        returns (address)
    {
        ...
        string memory MESSAGE_TYPE = "Message(address recipiant,string value,uint256 nonce)";
    ...
    returns (address)
{
    ...
    // stringified types
    string memory EIP712_DOMAIN_TYPE = "EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)";
    string memory MESSAGE_TYPE = "Message(string note,uint256 deadline)";
